...
#Clone the project
RUN wget -O ot-node.zip https://codeload.github.com/OriginTrail/ot-node/zip/feature/stable-broken
RUN unzip ot-node.zip -d . && rm ot-node.zip && mv ot-node-feature-stable-broken ot-node
